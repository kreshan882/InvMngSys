<%-- 
    ...
    Created on : Feb 6, 2016, 5:17:58 PM
    Author     : kreshan88
--%>
    ...
    <body style="overflow:hidden">
        <div class="wrapper">
            ...
            <div class="body_content" id="includedContent">
                    ...
                    <div class="heading">Add New Supplier</div>
                        ...
                        <s:form theme="simple" method="post" name="addcus" id="addcus">         
                            <table class="form_table" border="0px">
                                ...
                                <tr>
                                    ...
                                    <td><s:textfield id="suppName" name="suppName" cssClass="textField" /></td>
                                    <td class="content_td formLable"></td>
                                ...
                                <tr>
                                    <td colspan="3">
                                        <s:url var="addurl" action="AddaddSupplier"/>
