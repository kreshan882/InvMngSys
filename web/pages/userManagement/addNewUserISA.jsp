                    ...
                    <div class="contentcenter">
                        ...
                        <s:form theme="simple" method="post" name="adduser" id="adduser">         
                            <table class="form_table" border="0px">
                                <tr>
                                    <td class="content_td formLable">Institute<span class="mandatory">*</span></td>
                                    <td class="content_td formLable" width="5px;">:</td>
                                    <td><s:select id="institute" name="institute" headerKey="-1"  headerValue="---Select---"  list="%{InstituteList}" cssClass="textField"/></td>
                                    <td class="content_td formLable"></td>
                                    <td class="content_td formLable">User Name<span class="mandatory">*</span></td>
                                    <td class="content_td formLable">:</td>
                                    <td><s:textfield id = "userId" name="userId" cssClass="textField"  /></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="3">
                                        <s:url var="addurl" action="UserAddUseraddNewUserISA"/>
                                        <sj:submit 
                                        button="true"
                                        value="Save" 
                                        href="%{addurl}"
                                        targets="divmsg"
                                        cssClass="button_ssave"
                                        />
                                        <%--<sj:submit targets="divmsg" label="Save" value="Save" cssClass="button_ssave"/>--%>
