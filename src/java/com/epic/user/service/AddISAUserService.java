 ...
 *
 */
public class AddISAUserService {

    public boolean insertISADetails(AddISAUserBeen userBean ,  SessionUserBean sessionUserBean) throws Exception{
    ...
    public void getInstituteList(AddISAUserBeen userBean) throws Exception {
        Connection connection = null;
     ...
     public boolean checkUserName(AddISAUserBeen userBean) throws Exception {
        Connection connection = null;
        PreparedStatement ps = null;
        ResultSet result = null;
        boolean ok=false;
