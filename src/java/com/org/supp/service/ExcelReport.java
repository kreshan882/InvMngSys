...
public class ExcelReport {
    public static Object generateExcelReport(ViewSupplierInputBean inputBean) throws Exception {
        ...
        try {
            ...
            quary ="SELECT SUP_ID,NAME,EMAIL,ADDRESS,TP_OFFICE,TP_MOBILE,STATUS,CAST(REG_DATE AS CHAR) AS REG_DATE FROM ic_supplier";
            ...
            while (res.next()) {
                ...
                SupplierBeen databean = new SupplierBeen();
                 databean.setSuppId(res.getString("SUP_ID")); 
                 databean.setSuppName(res.getString("NAME"));
    ...
    private static XSSFWorkbook createExcelTableBodySection(XSSFWorkbook workbook, List<SupplierBeen> dataList) {
        ...
        while (++i < dataList.size()) {
            ...
            Cell cell = row.createCell(0);
            cell.setCellValue(dataList.get(i).getSuppId());
            cell.setCellStyle(rowColumnCell);

            cell = row.createCell(1);
            cell.setCellValue(dataList.get(i).getSuppName());
            cell.setCellStyle(rowColumnCell);
