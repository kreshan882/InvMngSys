...
public class AddSupplierService {
    ...
    public boolean addData(SupplierBeen userBean ,  SessionUserBean sessionUserBean) throws Exception{
        Connection con = null;
        String query;
        ...
        try {
            ...
            query="insert into ic_supplier(NAME,EMAIL,ADDRESS,TP_MOBILE,TP_OFFICE,STATUS,REG_DATE) "
                    + "VALUES(?,?,?,?,  ?,?,?)";
            
            preStat = con.prepareStatement(query);

            preStat.setString(1, userBean.getSuppName());
     ...
     public boolean checkSuppName(String suppname) throws Exception {
        ...
        try {
            ...
            String sql = "SELECT * FROM ic_supplier WHERE NAME=? ";
